...
\verb!patchDVI::pdf_document_with_concordance!.  The driver
automates the steps described above.
...
describes some common ones for Sweave/knitr.  The next section
...
\section{R Markdown Instructions}
...
\verb!patchDVI::pdf_document_with_concordance! \\
instead.  If it
was \verb!html_document!, use\\
\verb!patchDVI::html_document_with_concordance!.  \\
That should be
