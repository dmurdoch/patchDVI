...
3. Tell TeXWorks to open Sweave files by editing the file pattern configuration file `texworks-config.txt`.
This file is in the `configuration` folder of the TeXWorks home directory.  For example, I have this
line in my file:
```
